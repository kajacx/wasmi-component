...
pub fn instantiate_example_world(mut ctx: impl AsContextMut, component: &Component) -> ExampleExports {
    ...
    let funcs_add_s32 = TypedFunc::new(memory.clone(), module_func, cleanup_func);
    ...
    let funcs_get_name = TypedFunc::new(memory.clone(), module_func, cleanup_func);
    ...
    let add_u32 = TypedFunc::new(memory.clone(), module_func, cleanup_func);
    ...
    let add_f32 = TypedFunc::new(memory.clone(), module_func, cleanup_func);
