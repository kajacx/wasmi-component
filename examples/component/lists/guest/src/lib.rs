...
impl bindings::exports::wasmi_component::component_examples::round_trip::Guest for GuestComponent {
    fn list_s8(value: Vec<i8>) -> Vec<i8> {
        bindings::log(&format!("[GUEST]: Received Vec<i8> value {value:?}"));
    ...
    fn list_s16(value: Vec<i16>) -> Vec<i16> {
        bindings::log(&format!("[GUEST]: Received Vec<i16> value {value:?}"));
    ...
    fn list_s32(value: Vec<i32>) -> Vec<i32> {
        bindings::log(&format!("[GUEST]: Received Vec<i32> value {value:?}"));
    ...
    fn list_s64(value: Vec<i64>) -> Vec<i64> {
        bindings::log(&format!("[GUEST]: Received Vec<i64> value {value:?}"));
    ...
    fn list_u8(value: Vec<u8>) -> Vec<u8> {
        bindings::log(&format!("[GUEST]: Received Vec<u8> value {value:?}"));
    ...
    fn list_u16(value: Vec<u16>) -> Vec<u16> {
        bindings::log(&format!("[GUEST]: Received Vec<u16> value {value:?}"));
    ...
    fn list_u32(value: Vec<u32>) -> Vec<u32> {
        bindings::log(&format!("[GUEST]: Received Vec<u32> value {value:?}"));
    ...
    fn list_u64(value: Vec<u64>) -> Vec<u64> {
        bindings::log(&format!("[GUEST]: Received Vec<u64> value {value:?}"));
    ...
    fn list_f32(value: Vec<f32>) -> Vec<f32> {
        bindings::log(&format!("[GUEST]: Received Vec<f32> value {value:?}"));
    ...
    fn list_f64(value: Vec<f64>) -> Vec<f64> {
        bindings::log(&format!("[GUEST]: Received Vec<f64> value {value:?}"));
    ...
    fn list_bool(value: Vec<bool>) -> Vec<bool> {
        bindings::log(&format!("[GUEST]: Received Vec<bool> value {value:?}"));
    ...
    fn list_char(value: Vec<char>) -> Vec<char> {
        bindings::log(&format!("[GUEST]: Received Vec<char> value {value:?}"));
    ...
    fn list_string(value: Vec<String>) -> Vec<String> {
        bindings::log(&format!("[GUEST]: Received Vec<String> value {value:?}"));
