...
impl TestExampleExports {
    ...
    pub fn call_list_string<T>(
        &self,
        ctx: impl AsContextMut<Data = StoreData<T>>,
        value: impl LowerVal<Vec<String>>,
    ) -> Result<Vec<String>> {
